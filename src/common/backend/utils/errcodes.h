...
/* Class UE - Uncorrected Error & Warning */
#define ERRCODE_UE_COMMON_ERROR MAKE_SQLSTATE('U','E','0','0','0')
#define ERRCODE_UE_DIRTY_PAGE MAKE_SQLSTATE('U','E','0','0','1')
#define ERRCODE_UE_CLEAN_PAGE MAKE_SQLSTATE('U','E','0','0','2')
