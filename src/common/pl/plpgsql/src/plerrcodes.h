...
{
	"stream_not_supported", ERRCODE_STREAM_NOT_SUPPORTED
},
...
{
	"dop_value_out_of_range", ERRCODE_DOP_VALUE_OUT_OF_RANGE
},
...
{
	"regexp_mismatch", ERRCODE_REGEXP_MISMATCH
},
...
{
	"invalid_xml_error_context", ERRCODE_INVALID_XML_ERROR_CONTEXT
},
...
{
	"run_transaction_during_recovery", ERRCODE_RUN_TRANSACTION_DURING_RECOVERY
},

{
	"gxid_does_not_exist", ERRCODE_GXID_DOES_NOT_EXIST
},
...
{
	"SLOW_QUERY_statement_name", ERRCODE_SLOW_QUERY
},

{
	"active_session_profile", ERRCODE_ACTIVE_SESSION_PROFILE
},
...
{
	"invalid_tuple_for_trigger", ERRCODE_TRIGGERED_INVALID_TUPLE
},
...
{
	"initial_password_not_modified", ERRCODE_INITIAL_PASSWORD_NOT_MODIFIED
},

{
	"invalid_status", ERRCODE_INVALID_STATUS
},
...
{
	"assert_failed", ERRORCODE_ASSERT_FAILED
},

{
	"cache_lookup_failed", ERRCODE_CACHE_LOOKUP_FAILED
},

{
	"fetch_data_failed", ERRCODE_FETCH_DATA_FAILED
},

{
	"flush_data_size_mismatch", ERRCODE_FLUSH_DATA_SIZE_MISMATCH
},

{
	"relation_open_error", ERRCODE_RELATION_OPEN_ERROR
},

{
	"relation_close_error", ERRCODE_RELATION_CLOSE_ERROR
},

{
	"invalid_cache_plan", ERRCODE_INVALID_CACHE_PLAN
},
...
{
	"partition_error", ERRCODE_PARTITION_ERROR
},

{
	"invalid_attribute", ERRCODE_INVALID_ATTRIBUTE
},

{
	"invalid_agg", ERRCODE_INVALID_AGG
},

{
	"resource_pool_error", ERRCODE_RESOURCE_POOL_ERROR
},

{
	"plan_parent_not_found", ERRCODE_PLAN_PARENT_NOT_FOUND
},

{
	"modify_conflicts", ERRCODE_MODIFY_CONFLICTS
},

{
	"distribution_error", ERRCODE_DISTRIBUTION_ERROR
},
...
{
	"invalid", ERRCODE_INVALID_TEMP_OBJECTS
},

{
	"undefined_key", ERRCODE_UNDEFINED_KEY
},

{
	"duplicate_key", ERRCODE_DUPLICATE_KEY
},

{
	"undefined_cl_column", ERRCODE_UNDEFINED_CL_COLUMN
},
...
{
	"out_of_buffer", ERRCODE_OUT_OF_BUFFER
},
...
{
	"query_internal_cancel", ERRCODE_QUERY_INTERNAL_CANCEL
},
...
{
	"ru_stop_query", ERRCODE_RU_STOP_QUERY
},
...
{
	"file_read_failed", ERRCODE_FILE_READ_FAILED
},

{
	"file_write_failed", ERRCODE_FILE_WRITE_FAILED
},

{
	"encryped_column_wrong_data", ERRCODE_INVALID_ENCRYPTED_COLUMN_DATA
},
...
{
	"fdw_invalid_option_data", ERRCODE_FDW_INVALID_OPTOIN_DATA
},
...
{
	"fdw_invalid_list_length", ERRCODE_FDW_INVALID_LIST_LENGTH
},

{
	"fdw_invalid_server_type", ERRCODE_FDW_INVALID_SERVER_TYPE
},

{
	"fdw_operation_not_supported", ERRCODE_FDW_OPERATION_NOT_SUPPORTED
},

{
	"fdw_cross_storage_engine_transaction_not_supported", ERRCODE_FDW_CROSS_STORAGE_ENGINE_TRANSACTION_NOT_SUPPORTED
},

{
	"fdw_cross_storage_engine_query_not_supported", ERRCODE_FDW_CROSS_STORAGE_ENGINE_QUERY_NOT_SUPPORTED
},

{
	"fdw_cross_update_indexed_field_not_supported", ERRCODE_FDW_UPDATE_INDEXED_FIELD_NOT_SUPPORTED
},

{
	"fdw_too_many_indexes", ERRCODE_FDW_TOO_MANY_INDEXES
},

{
	"fdw_key_size_exceeds_max_allowed", ERRCODE_FDW_KEY_SIZE_EXCEEDS_MAX_ALLOWED
},

{
	"fdw_ddl_in_transaction_not_allowed", ERRCODE_FDW_DDL_IN_TRANSACTION_NOT_ALLOWED
},

{
	"fdw_too_many_index_columns", ERRCODE_FDW_TOO_MANY_INDEX_COLUMNS
},

{
	"fdw_index_on_nullable_column_not_allowed", ERRCODE_FDW_INDEX_ON_NULLABLE_COLUMN_NOT_ALLOWED
},

{
	"fdw_too_many_ddl_statements_in_transaction", ERRCODE_FDW_TOO_MANY_DDL_CHANGES_IN_TRANSACTION_NOT_ALLOWED
},
...
{
	"forall_need_dml", ERRCODE_FORALL_NEED_DML
},
...
{
	"stream_remote_close_socket", ERRCODE_STREAM_REMOTE_CLOSE_SOCKET
},

{
	"unrecognized_node_type", ERRCODE_UNRECOGNIZED_NODE_TYPE
},

{
	"unexpected_null_value", ERRCODE_UNEXPECTED_NULL_VALUE
},

{
	"unexpected_node_state", ERRCODE_UNEXPECTED_NODE_STATE
},

{
	"null_junk_attribute", ERRCODE_NULL_JUNK_ATTRIBUTE
},

{
	"optimizer_inconsistent_state", ERRCODE_OPTIMIZER_INCONSISTENT_STATE
},

{
	"stream_duplicate_query_id", ERRCODE_STREAM_DUPLICATE_QUERY_ID
},

{
	"invalid_buffer", ERRCODE_INVALID_BUFFER
},

{
	"invalid_buffer_reference", ERRCODE_INVALID_BUFFER_REFERENCE
},

{
	"node_id_missmatch", ERRCODE_NODE_ID_MISSMATCH
},

{
	"cannot_modify_xidbasea", ERRCODE_CANNOT_MODIFY_XIDBASE
},

{
	"unexpected_chunk_value", ERRCODE_UNEXPECTED_CHUNK_VALUE
},

{
	"cn_retry_stub", ERRCODE_CN_RETRY_STUB
},

{
	"codegen_error", ERRCODE_CODEGEN_ERROR
},

{
	"load_ir_function_failed", ERRCODE_LOAD_IR_FUNCTION_FAILED
},

{
	"load_intrinsic_function_failed", ERRCODE_LOAD_INTRINSIC_FUNCTION_FAILED
},

{
	"connection_reset_by_peer", ERRCODE_CONNECTION_RESET_BY_PEER
},

{
	"stream_connection_reset_by_peer", ERRCODE_STREAM_CONNECTION_RESET_BY_PEER
},

{
	"lock_wait_timeout", ERRCODE_LOCK_WAIT_TIMEOUT
},

{
	"connection_timed_out", ERRCODE_CONNECTION_TIMED_OUT
},

{
	"set_query_error", ERRCODE_SET_QUERY
},

{
	"out_of_logical_memory", ERRCODE_OUT_OF_LOGICAL_MEMORY
},

{
	"sctp_memory_alloc", ERRCODE_SCTP_MEMORY_ALLOC
},

{
	"sctp_no_data_in_buffer", ERRCODE_SCTP_NO_DATA_IN_BUFFER
},

{
	"sctp_release_memory_close", ERRCODE_SCTP_RELEASE_MEMORY_CLOSE
},

{
	"sctp_tcp_disconnect", ERRCODE_SCTP_TCP_DISCONNECT
},

{
	"sctp_disconnect", ERRCODE_SCTP_DISCONNECT
},

{
	"sctp_remote_close", ERRCODE_SCTP_REMOTE_CLOSE
},

{
	"sctp_wait_poll_unknow", ERRCODE_SCTP_WAIT_POLL_UNKNOW
},

{
	"snapshot_invalid", ERRCODE_SNAPSHOT_INVALID
},

{
	"connection_receive_wrong", ERRCODE_CONNECTION_RECEIVE_WRONG
},

{
	"stream_concurrent_update", ERRCODE_STREAM_CONCURRENT_UPDATE
},

{
	"spi_error", ERRCODE_SPI_ERROR
},

{
	"spi_connection_failure", ERRCODE_SPI_CONNECTION_FAILURE
},

{
	"spi_finish_failure", ERRCODE_SPI_FINISH_FAILURE
},

{
	"spi_prepare_failure", ERRCODE_SPI_PREPARE_FAILURE
},

{
	"spi_cursor_open_failure", ERRCODE_SPI_CURSOR_OPEN_FAILURE
},

{
	"spi_execute_failure", ERRCODE_SPI_EXECUTE_FAILURE
},

{
	"spi_improper_call_function", ERRORCODE_SPI_IMPROPER_CALL
},

{
	"pldebugger_internal_error", ERRCODE_PLDEBUGGER_ERROR
},

{
	"duplicate_breakpoint", ERRCODE_DUPLICATE_BREAKPOINT
},

{
	"function_hash_is_not_initialized", ERRCODE_FUNCTION_HASH_NOT_INITED
},

{
	"breakpoint_is_not_present", ERRCODE_BREAKPOINT_NOT_PRESENT
},

{
	"debug_server_already_is_attached", ERRCODE_TARGET_SERVER_ALREADY_ATTACHED
},

{
	"debug_server_not_attached", ERRCODE_TARGET_SERVER_NOT_ATTACHED
},

{
	"debug_server_already_in_sync", ERRCODE_DEBUG_SERVER_ALREADY_SYNC
},

{
	"debug_target_servers_not_in_sync", ERRCODE_DEBUG_TARGET_SERVERS_NOT_IN_SYNC
},

{
	"target_server_already_in_sync", ERRCODE_TARGET_SERVER_ALREADY_SYNC
},

{
	"non_existant_variable", ERRCODE_NONEXISTANT_VARIABLE
},

{
	"invalid_target_session_id", ERRCODE_INVALID_TARGET_SESSION_ID
},

{
	"invalid_operation", ERRCODE_INVALID_OPERATION
},

{
	"maximum_number_of_debug_sessions_reached", ERRCODE_MAX_DEBUG_SESSIONS_REACHED
},

{
	"maximum_number_of_breakpoints_reached", ERRCODE_MAX_BREAKPOINTS_REACHED
},

{
	"initialization_failed", ERRCODE_INITIALIZE_FAILED
},

{
	"rbtree_invalid_node_state", ERRCODE_RBTREE_INVALID_NODE_STATE
},

{
	"rbtree_invalid_iterator_order", ERRCODE_RBTREE_INVALID_ITERATOR_ORDER
},

{
	"operate_failed", ERRCODE_OPERATE_FAILED
},

{
	"operate_result_not_expected", ERRCODE_OPERATE_RESULT_NOT_EXPECTED
},

{
	"operate_not_supported", ERRCODE_OPERATE_NOT_SUPPORTED
},

{
	"operate_invalid_param", ERRCODE_OPERATE_INVALID_PARAM
},

{
	"index_operator_mismacth", ERRCODE_INDEX_OPERATOR_MISMATCH
},

{
	"no_function_provided", ERRCODE_NO_FUNCTION_PROVIDED
},

{
	"logical_decode_error", ERRCODE_LOGICAL_DECODE_ERROR
},

{
	"relfilenodemap", ERRCODE_RELFILENODEMAP
},

{
	"timeseries_common_error", ERRCODE_TS_COMMON_ERROR
},

{
	"column_key_type_mismatch", ERRCODE_TS_KEYTYPE_MISMATCH
},

{
	"uce_common_error", ERRCODE_UE_COMMON_ERROR
},

{
	"uce_dirty_page_error", ERRCODE_UE_DIRTY_PAGE
},

{
	"uce_clean_page_error", ERRCODE_UE_CLEAN_PAGE
},
